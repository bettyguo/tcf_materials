...
|---|---|---|---|---|
| T1 | B1 | ~1,5 min | obtenir des informations en posant des questions | [tache1/](tache1/index.md) |
| T2 | B2 | ~3 min | décrire une expérience / un sujet | [tache2/](tache2/index.md) |
| T3 | C1 | ~5 min (après 2 min de prép) | défendre une opinion à partir d'un document | [tache3/](tache3/index.md) |
...
| Kit phonologique (8 unités) | ✅ | [00_phonology/](00_phonology/index.md) |
| Programme 60 jours | ✅ | [00_program.md](00_program.md) |
| Sujets T1 + modèles 6/8/10 transcripts | 🟡 3/30 | [tache1/](tache1/index.md) · [_queue](tache1/_queue.md) |
| Sujets T2 + modèles 6/8/10 transcripts | 🟡 3/30 | [tache2/](tache2/index.md) · [_queue](tache2/_queue.md) |
| Sujets T3 + modèles 6/8/10 transcripts | 🟡 3/30 | [tache3/](tache3/index.md) · [_queue](tache3/_queue.md) |
...
2. Passer la **[phonologie complète](00_phonology/index.md)** en 2 semaines (1 unité par 3 jours).
...
- **[Pivots EE](../05_writing/00_pivots/index.md)** — les 193 phrases d'ouverture, transition, concession, etc., scorent autant en EO qu'en EE si elles sont vocalisées proprement.
